            ...
            <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-6">
                ...
                <div>
                    ...
                    <div class="space-y-0.5">
                        <a href="{{ route('clients') }}" class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-zinc-700 transition-colors hover:bg-zinc-100 dark:text-zinc-300 dark:hover:bg-zinc-800">
                        ...
                        <a href="{{ route('service-request-summary') }}" class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-zinc-700 transition-colors hover:bg-zinc-100 dark:text-zinc-300 dark:hover:bg-zinc-800">
                        ...
                        <a href="{{ route('schedule-summary') }}" class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-zinc-700 transition-colors hover:bg-zinc-100 dark:text-zinc-300 dark:hover:bg-zinc-800">
                ...
                <div>
                    ...
                    <div class="space-y-0.5">
                        <a href="{{ route('cleaners') }}" class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-zinc-700 transition-colors hover:bg-zinc-100 dark:text-zinc-300 dark:hover:bg-zinc-800">
