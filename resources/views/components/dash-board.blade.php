...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="min-h-screen bg-zinc-100" x-data="{ sidebarOpen: false }">
        ...
        <aside
            ...
            class="fixed inset-y-0 left-0 z-30 flex w-64 flex-col border-r border-zinc-200 bg-white transition-transform duration-300 lg:translate-x-0"
        >
            {{-- Brand --}}
            <div class="flex h-16 shrink-0 items-center gap-3 border-b border-zinc-200 px-5">
                ...
                <span class="text-sm font-semibold text-zinc-900">KPH Schedule</span>
            </div>
            ...
            <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-6">
                ...
                <div>
                    <p class="mb-1 px-2 text-xs font-semibold uppercase tracking-wider text-zinc-400">Overview</p>
                    <a href="{{ route('dashboard') }}" wire:navigate
                        class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition-colors
                            {{ request()->routeIs('dashboard') ? 'bg-blue-50 text-blue-700' : 'text-zinc-700 hover:bg-zinc-100' }}">
                ...
                <div>
                    <p class="mb-1 px-2 text-xs font-semibold uppercase tracking-wider text-zinc-400">Management</p>
                    <div class="space-y-0.5">
                        <a href="{{ route('clients') }}" class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-zinc-700 transition-colors hover:bg-zinc-100">
                        ...
                        <a href="{{ route('service-request-summary') }}" class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-zinc-700 transition-colors hover:bg-zinc-100">
                        ...
                        <a href="{{ route('schedule-summary') }}" class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-zinc-700 transition-colors hover:bg-zinc-100">
                ...
                <div>
                    <p class="mb-1 px-2 text-xs font-semibold uppercase tracking-wider text-zinc-400">Team</p>
                    <div class="space-y-0.5">
                        <a href="{{ route('cleaners') }}" class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-zinc-700 transition-colors hover:bg-zinc-100">
                        ...
                        <a href="#" class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-zinc-700 transition-colors hover:bg-zinc-100">
            ...
            <div class="border-t border-zinc-200 px-3 py-3 space-y-0.5">
                <a href="{{ route('profile.edit') }}" wire:navigate
                    class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-zinc-700 transition-colors hover:bg-zinc-100">
                ...
                <div x-data="{ open: false }" class="relative">
                    <button @click="open = !open"
                        class="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-zinc-700 transition-colors hover:bg-zinc-100">
                    ...
                    <div
                        ...
                        x-transition
                        class="absolute bottom-full left-0 right-0 mb-1 rounded-lg border border-zinc-200 bg-white py-1 shadow-lg"
                        style="display:none"
                    >
                        <a href="{{ route('profile.edit') }}" wire:navigate
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit"
                                class="flex w-full items-center gap-2 px-4 py-2 text-sm text-red-600 hover:bg-zinc-100">
        ...
        {{-- Top bar (mobile) --}}
        <div class="sticky top-0 z-10 flex h-14 items-center gap-3 border-b border-zinc-200 bg-white px-4 lg:hidden">
            <button @click="sidebarOpen = true" class="rounded-md p-1.5 text-zinc-500 hover:bg-zinc-100">
